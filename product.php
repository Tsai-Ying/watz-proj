...
<!--jquery-plugin-vegas  -->
    ...
    <style>
        /* -------------- */
<?php include __DIR__ . '/html-product-helpcss.php' ?>
                            ...
                            <form action="" class="bottom-right flex">
                                <div class="BR-left flex ">
                                    <div class="radio-group flex ">
                                        ...
                                        <h5>隱形襪</h5>
                                        <div>
                                            <input type="radio" class="radio-input goNext cursor" id="block2-btn1"
                                                name="number">
            ...
            <div class="block flex">
                <div class="selector flex">
                    <ul class="box-series">
                        ...
                        <li> <label class="cursor"><input type="checkbox" name="series2" value="series2"
                                    class="cursor">群魔亂舞</label></li>
                        <li><label class="cursor"><input type="checkbox" name="series3" value="series3"
                                    class="cursor">灰姑娘的水晶襪</label></li>
                        <li> <label class="cursor"><input type="checkbox" name="series4" value="series4" class="cursor">素色流行</label></li>
                        <li> <label class="cursor"><input type="checkbox" name="series5" value="series5"
                                    class="cursor">幾何色塊</label></li>
                        <li> <label class="cursor"><input type="checkbox" name="series6" value="series6"
                                    class="cursor">美式風格</label></li>
                    </ul>
                    <div class="box-color">
                        <p>Color</p>
                        <ul class="color-btn-box flex">
                            <li class="flex">  <img class="img-select-circle transition active" src="images/select circle.svg"
                                alt=""><button class="color-btn1 btn-border cursor"></button></li>
                            <li class="flex">
                                <img class="img-select-circle transition active" src="images/select circle.svg"
                                alt=""><button class="color-btn2 btn-border cursor"></button></li>
                            <li class="flex">
                                <img class="img-select-circle transition active" src="images/select circle.svg"
                                alt=""><button class="color-btn3 btn-border cursor"></button></li>
                            <li class="flex">
                                <img class="img-select-circle transition active" src="images/select circle.svg"
                                alt=""><button class="color-btn4 btn-border cursor"></button></li>
                            <li class="flex">
                                <img class="img-select-circle transition active" src="images/select circle.svg"
                                alt=""><button class="color-btn5 btn-border cursor"></button></li>
                            <li class="flex"> <img class="img-select-circle transition active" src="images/select circle.svg"
                                alt=""><button class="color-btn6 btn-border cursor"></button></li>
                            <li class="flex"> <img class="img-select-circle transition active" src="images/select circle.svg"
                                alt=""><button class="color-btn7 cursor"></button></li>
                            <li class="flex"> <img class="img-select-circle transition active" src="images/select circle.svg"
                                alt=""><button class="color-btn8 btn-border cursor"></button></li>
                        </ul>
                    </div>
                    <div class="box-type ">
                        <p>Type</p>
                        <div class="type-box flex">
                            ...
                            <ul class="type-btn-box">
                                <li> <label class="type-active cursor"><input type="checkbox" name="type1" value="type1"
                                            class="cursor">長襪</label></li>
                                <li><label class="type-active cursor"><input type="checkbox" name="type2" value="type2"
                                            class="cursor">短襪</label></li>
                                <li> <label class="cursor"><input type="checkbox" name="type3" value="type3"
                                            class="cursor">踝襪</label></li>
                                <li> <label class="cursor"><input type="checkbox" name="type4" value="type4"
                                            class="cursor">隱形襪</label></li>
                            </ul>
                        </div>
